...
| <a name="input_cidr_data"></a> [cidr\_data](#input\_cidr\_data) | This is the CIDR for data subnet | `map` | n/a | yes |
| <a name="input_cidr_private"></a> [cidr\_private](#input\_cidr\_private) | This is the CIDR for private subnet | `any` | n/a | yes |
| <a name="input_cidr_public"></a> [cidr\_public](#input\_cidr\_public) | This is the CIDR for public subnet | `any` | n/a | yes |
